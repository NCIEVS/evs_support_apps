...
public class ProgressBarMaker extends JFrame {
    ...
    public ProgressBarMaker(gov.nih.nci.evs.restapi.appl.InferredFileGenerator generator, Vector classIdVec) {
    ...
    public Vector fill() {
		...
		boolean ADD_PROPERTY_PREFIX = generator.get_ADD_PROPERTY_PREFIX();
		boolean NCIT_CODE_ONLY = generator.get_NCIT_CODE_ONLY();
