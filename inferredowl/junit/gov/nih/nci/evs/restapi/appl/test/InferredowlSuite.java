...
public class InferredowlSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "gov.nih.nci.evs.restapi.appl.test.Test";

    public static void main(String args[]) {
        new TestSuite(InferredowlSuite.class).run(new TestResult());
    }
